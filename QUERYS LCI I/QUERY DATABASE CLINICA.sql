...
--ALTER TABLE PACIENTES ADD id_tipo_doc INT;

--ALTER TABLE PACIENTES ADD CONSTRAINT FK_TIPOS_DOC_PACIENTES FOREIGN KEY (id_tipo_doc)
...
/*ALTER TABLE PACIENTES DROP nombre,apellido;

ALTER TABLE PACIENTES DROP COLUMN id_barrio,id_genero,id_tipo_telefono,id_tipo_doc;

ALTER TABLE PACIENTES DROP CONSTRAINT FK_BARRIOS_PACIENTES;
ALTER TABLE PACIENTES DROP CONSTRAINT FK_GENEROS_PACIENTES;
ALTER TABLE PACIENTES DROP CONSTRAINT FK_TIPOS_DOC_PACIENTES;

ALTER TABLE PACIENTES ADD id_persona INT ;

ALTER TABLE PACIENTES ADD CONSTRAINT FK_PERSONAS_PACIENTES FOREIGN KEY
...
ALTER TABLE MEDICOS DROP COLUMN nombre, apellido;
ALTER TABLE MEDICOS DROP CONSTRAINT FK_GENEROS_MEDICOS;
ALTER TABLE MEDICOS DROP COLUMN id_genero;
ALTER TABLE MEDICOS ADD id_persona INT;
ALTER TABLE MEDICOS ADD CONSTRAINT FK_PERSONAS_MEDICOS FOREIGN KEY (id_persona)
...
ALTER TABLE PERSONAS ADD cuil INT;
