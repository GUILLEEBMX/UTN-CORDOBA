...
DELETE FROM FACTURAS WHERE id_factura = 7;


SELECT F.id_factura AS 'FACTURA', DF.id_detalle AS 'DETALLE'
...
DELETE FROM DETALLES_FACTURAS WHERE id_factura = 7;
...
/*CREATE PROCEDURE SP_DELETE_DETAIL_INVOICE
@invoice int 
AS
BEGIN
 DELETE FROM DETALLES_FACTURAS WHERE id_factura = @invoice;
END
GO
...
AS
BEGIN
 DELETE FROM FACTURAS WHERE id_factura = @invoice;
END
GO*/
